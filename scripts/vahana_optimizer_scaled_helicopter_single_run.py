'''
# Name: vahana_optimizer_scaled_helicopter_single_run.py
...
if __name__ == '__main__':
    ...
    for i in db_keys:
        ...
        print('Range (km): {}, DOC ($): {}, rProp (m): {}, cruiseSpeed (m/s): {}, batteryMass (kg): {}, motorMass (kg): {}, mtom (kg): {}, \
            ...
            DEBUG: cruisePower_PCruise = {}, DEBUG: cruisePower_PBattery = {}' \
            ...
            data['Unknowns']['subprob.CruisePower.PCruise'], data['Unknowns']['subprob.CruisePower.PBattery']))
